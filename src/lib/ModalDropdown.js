...
import CustomFlatList from "../scenes/components/CustomFlatList";
...
export default class ModalDropdown extends Component {
      ...
      >
        {children || (
          <View style={styles.button}>
            <CustomText style={[styles.buttonText, textStyle]} numberOfLines={1}>
              {buttonText}
            </CustomText>
            <Ionicons
  ...
  _renderRow = (rowData, sectionID) => {
    ...
    const row = !renderRow ? (
      ...
      renderRow(rowData, rowID, selectedIndex)
    );
